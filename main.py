...
# Layout: [Title (8)] [About Button (2)] [Profile/Auditor Toggle (2)]
...
if st.session_state.page == "About":
    ...
    if st.session_state.current_view:
        # Results View (from History or New Scan)
        ...
        st.subheader("Analyze Your Codebase")
        st.write(f"Auditing as: **{st.session_state.persona}**")
